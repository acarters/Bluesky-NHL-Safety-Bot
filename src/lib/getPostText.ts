...
export default async function getPostText() 
{
	...
	var awaitTweet = await mastodon.getStatuses("109701453206967080", {'limit':limitVal}); //Use the Mastodon API to get a specified number of recent posts from the Mastodon API.
